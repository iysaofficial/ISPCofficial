            ...
            <form name="regist-form">
              ...
              <div className="user-details">
                <div className="input-box">
                  <label htmlFor="CATEGORY_PARTICIPANT" className="form-label">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="International Science Project Competition - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="International Science Project Competition - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
